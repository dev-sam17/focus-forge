...
import { Clock, Trash2, Archive, RotateCcw } from "lucide-react";
        ...
        <CardFooter className="p-4 pt-0">
          <div className="flex gap-2 w-full">
            <Button
              ...
              className="flex-1 border-primary/30 text-primary hover:bg-primary/10 hover:border-primary/50 transition-all duration-300 group/btn"
            >
              <RotateCcw className="h-4 w-4 mr-2 group-hover/btn:animate-spin" />
              Unarchive
            </Button>
            ...
            >
              <DialogTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="flex-1 border-destructive/30 text-destructive hover:bg-destructive/10 hover:border-destructive/50 transition-all duration-300 group/btn"
                >
